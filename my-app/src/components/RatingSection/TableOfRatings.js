...
function TableOfRatings({ setLandfields, setNumbers, setName, dbData }) {
  ...
  // table style
  const tableStyleMobile = mediaqueryStyle;
      ...
      {mediaquery ? (
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 360 }} size="small" aria-label="a dense table">
            <TableHead>
              <TableRow>
                <TableCell style={tableStyleMobile} align="left">
                  Map Name
                </TableCell>
                <TableCell style={tableStyleMobile} align="left">
                  Votes
                </TableCell>
                <TableCell style={tableStyleMobile}>Average Rating</TableCell>
                <TableCell style={tableStyleMobile} align="left"></TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {tableData.map((row) => {
